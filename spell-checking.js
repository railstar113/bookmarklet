javascript: (() => {
  const words = ["予め", "併せ", "いったん", "及び", "下さ", "る事", "た事", "な事", "の事", "う事", "先程", "更に", "既に", "全て", "ぜひ", "沢山", "但し", "為", "出来", "問合", "通り", "殆ど", "又", "まったく", "迄", "様な", "様に", "宜しく", "ヵ月", "か月", "カ月", "ケ月", "おこな", "子供", "こども", "弊社", "PC", "HP", "一つ一つ", "一人々", "等", "頂", "致", "ご対応", "共に", "伴"];
